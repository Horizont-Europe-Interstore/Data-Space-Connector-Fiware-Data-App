...
public class ContextBrokerErrorHandler {
	...
	private Message createResultMessage(Message header) {
		// Mandatory fields are: securityToken, correlationMessage, issuerConnector,
		// senderAgent, modelVersion, issued
		return new ResultMessageBuilder()
				...
				._recipientConnector_(
						header != null ? asList(header.getIssuerConnector()) : asList(whoIAmEngRDProvider()))
